...
## Decisions needed
- [ ] Move the three Squarespace domain registrations (ednoka.com, godothire.com, edouardmurat.com) to IONOS and close Squarespace. Order and DNS precautions in docs/BRANDING.md, Consolidating accounts section. Progress 2026-09-08: DNS of all three snapshotted in docs/dns/, all three unlocked at Squarespace and auth codes requested (emailed to edouardmurat1@gmail.com, up to 24 h). IONOS transfer flow reached for edouardmurat.com on contract 106801127 (VPS Linux M), asks for the auth code, $9.50 first year then $20/year per .com. Left: Eddy's OK on the three purchases, enter codes, order, recreate DNS at IONOS, approve transfer emails, then close Squarespace
